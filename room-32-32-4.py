...
# base_folder = os.path.join(dir_path, './data_store/room-32-32-4/add_and_delete_obstacles')
# base_folder = os.path.join(dir_path, './data_store/room-32-32-4/only_delete_obstacles')
# base_folder = os.path.join(dir_path, './data_store/room-32-32-4/only_add_obstacles')
# test_name = "room-32-32-4 add_and_delete_obstacles"

scen_counts = 25 + 1
agent_max_counts = 12 + 2
agent_start_num = 4


data_folder_name = "room-32-32-4"
...
for i in range(1, scen_counts, 1):
    ...
    for j in range(4, agent_max_counts, 2):
        ...
        new_cbs_result_file = base_folder + "/room-32-32-4-even-" + scen_file_id + "/" + agent_num + "/new_cbs_result.json"
        old_cbs_result_file = base_folder + "/room-32-32-4-even-" + scen_file_id + "/" + agent_num + "/old_cbs_result.json"
