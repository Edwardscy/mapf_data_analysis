...
# base_folder = os.path.join(dir_path, './data_store/room-64-64-8/add_and_delete_obstacles')
# base_folder = os.path.join(dir_path, './data_store/room-64-64-8/only_delete_obstacles')
# base_folder = os.path.join(dir_path, './data_store/room-64-64-8/only_add_obstacles')
# test_name = "room-64-64-8 add_and_delete_obstacles"

scen_counts = 25 + 1
agent_max_counts = 16 + 2
agent_start_num = 4


data_folder_name = "room-64-64-8"
...
xlabel_name = "Number of obstacle added"
ylabel_name = "runtime_diff / sec"


dir_path = os.path.dirname(os.path.realpath(__file__))
base_folder = os.path.join(dir_path, "./data_store/clear_1000/")
base_folder = base_folder + "/" + data_folder_name + "/" + test_model

base_save_pic_name = data_folder_name + "_" + test_model

thesis_report_picture_folder = os.path.join(dir_path, "./thesis_report_picture/clear_1000")
...
for i in range(1, scen_counts, 1):
    ...
    for j in range(4, agent_max_counts, 2):
        ...
        new_cbs_result_file = base_folder + "/room-64-64-8-even-" + scen_file_id + "/" + agent_num + "/new_cbs_result.json"
        old_cbs_result_file = base_folder + "/room-64-64-8-even-" + scen_file_id + "/" + agent_num + "/old_cbs_result.json"
